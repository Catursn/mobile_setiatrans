...
--
-- Host: localhost:3306
-- Waktu pembuatan: 07 Jul 2021 pada 11.27
...
--
-- Struktur dari tabel `acc_coa_type`
--
...
--
-- Dumping data untuk tabel `acc_coa_type`
--
...
(1, '1', 'ASSET', 'Head', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 0, 0),
(2, '11', 'Current Asset', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 1, 0),
(3, '111', 'Cash', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 2, 0),
(4, '1111', 'Cash On Hand', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 3, 0),
(5, '11111', 'Cash-Rupiah', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 4, 0),
(6, '111111', 'Cash-Rupiah', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 5, 0),
(7, '111112', 'Petty Cash-Rupiah', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 5, 0),
(8, '11112', 'Cash-US Dollar', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 4, 0),
(9, '111121', 'Cash-US Dollar', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 8, 0),
(10, '1112', 'Cash On Bank', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 3, 0),
(11, '11121', 'BCA', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 5, 0),
(12, '111211', 'BCA ', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 5, 0),
(13, '11123', 'BRI', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 5, 0),
(14, '111231', 'BRI', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 5, 0),
(15, '1113', 'Kas Penyesuaian', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 3, 0),
(16, '11131', 'kas Penyesuaian', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 5, 0),
(17, '111311', 'Kas Penyesuaian', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 5, 0),
(18, '112', 'STOCK', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 2, 0),
(19, '113', 'Account Receiable', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 2, 0),
(20, '1131', 'Piutang Konsumen', '', 'Debet', 'Aktiva Tetap', 'Neraca', '', '', 'pemasukan', 19, 0),
(21, '113101', 'Piutang Konsumen', '', 'Debet', 'Aktiva Tetap', 'Neraca', '', '', 'pemasukan', 20, 0),
(22, '1136', 'Piutang Non Konsumen', '', 'Debet', 'Aktiva Tetap', 'Neraca', '', '', 'pemasukan', 19, 0),
(23, '113601', 'Piutang Non Konsumen', '', 'Debet', 'Aktiva Tetap', 'Neraca', '', '', 'pemasukan', 22, 0),
(24, '114', 'Prepaid Rent', '', 'Debet', 'Aktiva Tetap', 'Neraca', '', '', 'pemasukan', 2, 0),
(25, '1141', 'Prepaid Rent (Building)', '', 'Debet', 'Aktiva Lancar', 'Neraca', '', '', 'pemasukan', 24, 0),
(26, '114101', 'Prepaid Rent Tanah', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 25, 0),
(27, '114102', 'Prepaid Rent Bangunan', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 25, 0),
(28, '1142', 'Prepaid  (Internet)', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 24, 0),
(29, '114201', 'Prepaid Domain', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 28, 0),
(30, '12', 'Fixed Asset', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 1, 0),
(31, '121', 'Equipment', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 30, 0),
(32, '121001', 'Equipment Kantor', '', 'Debet', 'Hutang Jangka Panjang', 'Neraca', '', '', 'pemasukan', 31, 0),
(33, '122', 'Lahan', '', 'Debet', 'Hutang Jangka Panjang', 'Neraca', '', '', 'pemasukan', 30, 0),
(34, '122001', 'Tanah  ', '', 'Debet', 'Hutang Jangka Panjang', 'Neraca', '', '', 'pemasukan', 33, 0),
(35, '123', 'Bangunan', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 30, 0),
(36, '123001', 'Bangunan', '', 'Debet', 'Hutang Lancar', 'Neraca', '', '', 'pemasukan', 35, 0),
(37, '124', 'Kendaraan', '', 'Debet', 'Modal', 'Neraca', '', '', 'pemasukan', 30, 0),
(38, '1241', 'Kendaraan Besar', '', 'Debet', 'Modal', 'Neraca', '', '', 'pemasukan', 37, 0),
(39, '124101', 'Truk No Pol', '', 'Debet', 'Modal', 'Neraca', '', '', 'pemasukan', 38, 0),
(40, '1245', 'Kendaraan Kecil', '', 'Debet', 'Modal', 'Neraca', '', '', 'pemasukan', 37, 0),
(41, '124501', 'Mobil No Pol', '', 'Debet', 'Pendapatan', 'Neraca', '', '', 'pemasukan', 40, 0),
(42, '1249', 'Kendaraan Pribadi', '', 'Debet', 'Pendapatan', 'Neraca', '', '', 'pemasukan', 37, 0),
(43, '124901', 'Mobil No Pol', '', 'Debet', 'Pendapatan', 'Neraca', '', '', 'pemasukan', 42, 0),
(44, '125', 'Mesin/Alat', '', 'Debet', 'Harga Pokok Penjualan', 'Neraca', '', '', 'pemasukan', 30, 0),
(45, '1251', 'Alat Berat', '', 'Debet', 'Harga Pokok Penjualan', 'Neraca', '', '', 'pemasukan', 44, 0),
(46, '125101', 'Alat Berat', '', 'Debet', 'Harga Pokok Penjualan', 'Neraca', '', '', 'pemasukan', 45, 0),
(47, '126', 'Acc. Depr. Equipment', '', 'Debet', 'Beban Administrasi Umum', 'Neraca', '', '', 'pemasukan', 30, 0),
(48, '1261', 'Acc. Depr. Equipment', '', 'Debet', 'Beban Administrasi Umum', 'Neraca', '', '', 'pemasukan', 47, 0),
(49, '12611', 'Acc. Depr. Equipment', '', 'Debet', 'Beban Administrasi Umum', 'Neraca', '', '', 'pemasukan', 48, 0),
(50, '126111', 'Acc. Depre. Equipment-Computer', '', 'Debet', 'Pendapatan Lain-lain ', 'Neraca', '', '', 'pemasukan', 49, 0),
(51, '13', 'Intangible Asset', '', 'Debet', 'Aktiva Tetap', 'Neraca', '', '', 'pemasukan', 1, 0),
(52, '131', 'Intangible Asset', '', 'Debet', 'Beban Lain-lain', 'Neraca', '', '', 'pemasukan', 51, 0),
(53, '1311', 'Intangible Asset', '', 'Debet', 'Beban Lain-lain', 'Neraca', '', '', 'pemasukan', 52, 0),
(54, '13111', 'Intangible Asset', '', 'Debet', 'Pendapatan Lain-lain ', 'Neraca', '', '', 'pemasukan', 53, 0),
(55, '131111', 'Intangible Asset', '', 'Debet', 'Kas/Bank', 'Neraca', '', '', 'pemasukan', 54, 0),
(56, '2', 'LIABILITIES', 'Head', 'Kredit', 'Kas/Bank', 'Neraca', '', '', 'pengeluaran', 0, 0),
(57, '21', 'Hutang-Bank', '', 'Kredit', 'Kas/Bank', 'Neraca', '', '', 'pengeluaran', 56, 0),
(58, '211', 'Hutang-Bank', '', 'Kredit', 'Kas/Bank', 'Neraca', '', '', 'pengeluaran', 57, 0),
(59, '2111', 'Hutang-Bank', '', 'Kredit', 'Aktiva Tetap', 'Neraca', '', '', 'pengeluaran', 58, 0),
(60, '21111', 'Hutang-Bank', '', 'Kredit', 'Aktiva Tetap', 'Neraca', '', '', 'pengeluaran', 59, 0),
(61, '211111', 'Hutang Giro BRI', '', 'Kredit', 'Aktiva Lancar', 'Neraca', '', '', 'pengeluaran', 60, 0),
(62, '212', 'Hutang ke Kartu Kredit', '', 'Kredit', 'Hutang Lancar', 'Neraca', '', '', 'pengeluaran', 57, 0),
(63, '2121', 'Hutang ke Kartu Kredit', '', 'Kredit', 'Beban Administrasi Umum', 'Neraca', '', '', 'pengeluaran', 62, 0),
(64, '21211', 'Hutang ke Kartu Kredit', '', 'Kredit', 'Pendapatan Lain-lain ', 'Neraca', '', '', 'pengeluaran', 63, 0),
(65, '213', 'Hutang Ke Suplier', '', 'Kredit', 'Beban Lain-lain', 'Neraca', '', '', 'pengeluaran', 57, 0),
(66, '213001', 'Hutang PT. X', '', 'Kredit', 'Aktiva Lancar', 'Neraca', '', '', 'pengeluaran', 25, 0),
(67, '214', 'Hutang ke Personal', '', 'Kredit', 'Aktiva Lancar', 'Neraca', '', '', 'pengeluaran', 57, 0),
(68, '214001', 'Hutang Rumah Summarecon', '', 'Kredit', 'Hutang Lancar', 'Neraca', '', '', 'pengeluaran', 35, 0),
(69, '215', 'Refund', '', 'Kredit', 'Beban Administrasi Umum', 'Neraca', '', '', 'pengeluaran', 57, 0),
(70, '215001', 'Refund', '', 'Kredit', 'Beban Administrasi Umum', 'Neraca', '', '', 'pengeluaran', 103, 0),
(71, '3', 'CAPITAL', 'Head', 'Kredit', 'Beban Administrasi Umum', 'Neraca', '', '', 'pengeluaran', 0, 0),
(72, '31', 'Capital', '', 'Kredit', 'Aktiva', 'Neraca', '', '', 'pengeluaran', 71, 0),
(73, '311', 'Capital Stock', '', 'Kredit', 'Income', 'Neraca', '', '', 'pengeluaran', 72, 0),
(74, '3111', 'Capital Stock', '', 'Kredit', 'Aktiva', 'Neraca', '', '', 'pengeluaran', 73, 0),
(75, '31111', 'Capital Stock', '', 'Kredit', 'Aktiva', 'Neraca', '', '', 'pengeluaran', 74, 0),
(76, '311111', 'Capital Stock', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 75, 0),
(77, '32', 'Deviden', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 71, 0),
(78, '321', 'Deviden', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 77, 0),
(79, '3211', 'Deviden', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 78, 0),
(80, '32111', 'Deviden', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 79, 0),
(81, '321111', 'Deviden', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 80, 0),
(82, '33', 'Retained Earning', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 71, 0),
(83, '331', 'Retained Earning', '', 'Kredit', 'Hutang Lancar', 'Neraca', '', '', 'pengeluaran', 82, 0),
(84, '3311', 'Retained Earning', '', 'Kredit', 'Pendapatan', 'Neraca', '', '', 'pengeluaran', 83, 0),
(85, '33111', 'Retained Earning', '', 'Kredit', 'Harga Pokok Penjualan', 'Neraca', '', '', 'pengeluaran', 84, 0),
(86, '331111', 'Retained Earning', '', 'Kredit', 'Harga Pokok Penjualan', 'Neraca', '', '', 'pengeluaran', 85, 0),
(87, '4', 'PENDAPATAN', 'Head', 'Kredit', 'Harga Pokok Penjualan', 'Laba Rugi', '', '', 'pengeluaran', 0, 0),
(88, '41', 'PENDAPATAN', '', 'Kredit', 'Harga Pokok Penjualan', 'Laba Rugi', '', '', 'pengeluaran', 87, 0),
(89, '411', 'PENDAPATAN', '', 'Kredit', 'Harga Pokok Penjualan', 'Laba Rugi', '', '', 'pengeluaran', 88, 0),
(90, '4111', 'PENDAPATAN', '', 'Kredit', 'Harga Pokok Penjualan', 'Laba Rugi', '', '', 'pengeluaran', 89, 0),
(91, '411101', 'Pend Expedisi', '', 'Kredit', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pengeluaran', 90, 0),
(92, '412', 'PENDAPATAN LAIN2', '', 'Kredit', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pengeluaran', 88, 0),
(93, '412111', 'PENDAPAT SEWA', '', 'Kredit', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pengeluaran', 92, 0),
(94, '412112', 'Pendapatan Komisi', '', 'Kredit', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pengeluaran', 92, 0),
(95, '5', 'COGS', 'Head', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 0, 0),
(96, '51', 'COGS', '', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 95, 0),
(97, '511', 'COGS', '', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 96, 0),
(98, '51111', 'COGS', '', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 97, 0),
(99, '511101', 'COGS Expedisi', '', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 98, 0),
(100, '6', 'OPR. EXPENSE', 'Head', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 0, 0),
(101, '61', 'OPR. EXPENSE', '', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 100, 0),
(102, '611', 'OPR. EXPENSE', '', 'Debet', 'Beban Administrasi Umum', 'Laba Rugi', '', '', 'pemasukan', 101, 0),
(103, '611001', 'Rent Expense', '', 'Debet', 'Expenses', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(104, '611002', 'Marketing Expense', '', 'Debet', 'Beban Penjualan', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(105, '611003', 'HRD Expense', '', 'Debet', 'Beban Penjualan', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(106, '611004', 'General & Administration Expense', '', 'Debet', 'Beban Penjualan', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(107, '611005', 'Transportation Expense', '', 'Debet', 'Beban Penjualan', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(108, '611006', 'Maintenace Expense', '', 'Debet', 'Beban Penjualan', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(109, '611007', 'Communication Expense', '', 'Debet', 'Pendapatan Lain-lain ', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(110, '611008', 'Consumtion Expense', '', 'Debet', 'Beban Lain-lain', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(111, '611009', 'Corporate Activity Expense', '', 'Debet', 'Harga Pokok Penjualan', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(112, '611010', 'Entertain Expense', '', 'Debet', 'Hutang Lancar', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(113, '611011', 'Packaging Expense', '', 'Debet', 'Aktiva Lancar', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(114, '611012', 'Electrikal Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(115, '611013', 'Pemeliaharan Kendaraan Kantor', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(116, '611014', 'Pajak Kendaraan', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(117, '611015', 'Komisi ', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(118, '611016', 'Audit', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 102, 0),
(119, '612', 'DEPRETITATION EXPENSE', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 101, 0),
(120, '612001', 'Depretiation Kendaraan', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 25, 0),
(121, '7', 'OTHER REVENUE/EXPENSE', 'Head', 'Kredit', '', 'Laba Rugi', '', '', 'pengeluaran', 0, 0),
(122, '71', 'Other Revenue', '', 'Kredit', '', 'Laba Rugi', '', '', 'pengeluaran', 121, 0),
(123, '711', 'Other Revenue', '', 'Kredit', '', 'Laba Rugi', '', '', 'pengeluaran', 122, 0),
(124, '7111', 'Other Revenue', '', 'Kredit', '', 'Laba Rugi', '', '', 'pengeluaran', 123, 0),
(125, '711101', 'Other Revenue', '', 'Kredit', '', 'Laba Rugi', '', '', 'pengeluaran', 124, 0),
(126, '711102', 'Consumen Incentive', '', 'Kredit', '', 'Laba Rugi', '', '', 'pengeluaran', 124, 0),
(127, '711103', 'Bank Incentive', '', 'Kredit', '', 'Laba Rugi', '', '', 'pengeluaran', 124, 0),
(128, '72', 'Other Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 121, 0),
(129, '721', 'Biaya Pribadi', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 128, 0),
(130, '721001', 'Asuransi Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(131, '721002', 'Leasing Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(132, '721003', 'Bank Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(133, '721004', 'Rumah Tangga Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(134, '721005', 'Zakat Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(135, '721006', 'Sodaqoh Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(136, '721007', 'Makan Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(137, '721008', 'Operasional Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(138, '721009', 'Pendidikan Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(139, '721010', 'Beli Barang Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(140, '721011', 'Iuran Expense', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(141, '721012', 'Pemeliharaan Kendaraan', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(142, '721013', 'Pajak Mobil dan Motor', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(143, '721014', 'Pajak', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(144, '721015', 'Cicilan Rumah Summarecon', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 129, 0),
(145, '8', 'TAX', 'Head', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 0, 0),
(146, '81', 'Tax', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 145, 0),
(147, '811', 'Tax', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 146, 0),
(148, '8111', 'Tax', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 147, 0),
(149, '81111', 'Tax', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 148, 0),
(150, '811111', 'Tax', '', 'Debet', '', 'Laba Rugi', '', '', 'pemasukan', 149, 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `acc_general_ledger`
--
...
--
-- Dumping data untuk tabel `acc_general_ledger`
--
...
--
-- Struktur dari tabel `acc_nama_kas_tbl`
--
...
--
-- Dumping data untuk tabel `acc_nama_kas_tbl`
--
...
--
-- Struktur dari tabel `acc_saldo_awal`
--
...
--
-- Struktur dari tabel `acc_sources`
--
...
--
-- Dumping data untuk tabel `acc_sources`
--
...
--
-- Struktur dari tabel `biaya_kendaraan`
--
...
CREATE TABLE `biaya_kendaraan` (
  ...
  `kendaraan_biaya_jenis_id` int(11) NOT NULL
...
CREATE TABLE `daftar_piutang` (
  ...
  `id_amplop` varchar(255) DEFAULT NULL,
...
INSERT INTO `daftar_piutang` (`id_piutang`, `coa`, `id_pelanggan`, `tgl_transaksi`, `id_amplop`, `jumlah_piutang`, `jumlah_bayar`, `keterangan`, `status`, `sisa_piutang`) VALUES
(16, '113101', 'CST0001', '2021-07-03', 'TTB20210001', 10000, 0, NULL, 'Belum Lunas', 10000),
(17, '113101', 'CST0001', '2021-07-03', 'TTB20210002', 10000, 0, NULL, 'Belum Lunas', 10000),
(18, '113101', 'CST0005', '2021-07-03', 'TTB20210003', 10000, 0, NULL, 'Belum Lunas', 10000),
(19, '113101', 'CST0001', '2021-07-03', 'TTB20210004', 10000, 0, NULL, 'Belum Lunas', 10000);
...
CREATE TABLE `data_pembayaran` (
  `id` int(11) NOT NULL,
  `pembayaran_jenis_id` int(11) NOT NULL,
  `data_nama` varchar(255) NOT NULL,
  `data_jenis` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `gaji` (
  ...
  `tunjangan_lainnya` int(11) NOT NULL,
  `potongan` int(11) NOT NULL,
  `pajak_pph21` int(11) NOT NULL,
...
--
-- Struktur dari tabel `kendaraan_biaya_jenis`
--

CREATE TABLE `kendaraan_biaya_jenis` (
  `id` int(11) NOT NULL,
...
--
-- Struktur dari tabel `lokasi_driver`
--

CREATE TABLE `lokasi_driver` (
  `id` int(11) NOT NULL,
  `lat` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `lokasi_driver`
--

INSERT INTO `lokasi_driver` (`id`, `lat`, `long`, `keterangan`, `driver_id`, `timestemp`) VALUES
(1, '-7', '108', 'Test Input', 5, '2021-05-31 11:42:40'),
(2, '-7', '108', 'Test Input Baru', 5, '2021-06-18 08:42:34'),
(3, '-7', '108', 'Test Input Baru', 5, '2021-06-18 11:55:55'),
(4, '-7', '108', 'Test Input Baru', 5, '2021-06-18 11:56:52'),
(5, '-7', '108', 'Test Input Baru', 5, '2021-06-18 11:57:08'),
(6, '-7', '108', 'Test Input Baru', 5, '2021-06-18 11:57:16'),
(7, '-7', '108', 'Test Input Baru', 5, '2021-06-18 11:57:40'),
(8, '-7', '108', 'Test Input Baru', 5, '2021-06-18 11:58:46'),
(9, '-7', '108', 'Test Input Baru', 5, '2021-06-18 12:00:06'),
(10, '-7', '108', 'Test Input Baru', 5, '2021-06-18 12:01:21'),
(11, '-7', '108', 'Test Input Baru', 5, '2021-06-18 12:01:45'),
(12, '-7', '108', 'Test Input Baru', 5, '2021-06-18 12:04:21'),
(13, '-7', '108', 'Test Input Baru', 5, '2021-06-18 12:08:41'),
(14, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:43:26'),
(15, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:43:38'),
(16, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:43:54'),
(17, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:43:56'),
(18, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:45:19'),
(19, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:45:21'),
(20, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:45:25'),
(21, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:45:27'),
(22, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:45:31'),
(23, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:46:24'),
(24, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:46:53'),
(25, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:47:14'),
(26, '-7', '108', 'Test Input Baru', 5, '2021-06-19 15:47:19'),
(27, '-7', '108', 'Test Input Baru', 5, '2021-06-21 15:32:57'),
(28, '-7', '108', 'Test Input Baru', 5, '2021-06-21 15:51:55'),
(29, '-7', '108', 'Test Input Baru', 5, '2021-06-21 16:53:06'),
(30, '-6.9514391', '107.6655465', 'Test Input Baru NEW', 5, '2021-07-01 09:58:55'),
(31, '-6.951439', '107.661169', 'Test Input Baru', 6, '2021-07-01 10:00:05'),
(32, '10', '10', 'a', 5, '0000-00-00 00:00:00'),
(33, '-6.9512604', '107.6648805', 'Test Input Baru', 5, '2021-07-02 07:35:06'),
(34, '-6.9512629', '107.6653172', 'Test Input Baru', 5, '2021-07-02 07:36:55'),
(35, '-6.9513897', '107.6654167', 'Test Input Baru', 5, '2021-07-02 07:44:02'),
(36, '-6.9513874', '107.6654162', 'Test Input Baru', 5, '2021-07-02 07:44:19'),
(37, '-6.9513876', '107.665417', 'Test Input Baru', 5, '2021-07-02 07:45:01'),
(38, '-6.9497631', '107.6649358', 'Test Input Baru', 5, '2021-07-02 07:45:41'),
(39, '-6.9514771', '107.6654683', 'Test Input Baru', 5, '2021-07-02 07:45:56'),
(40, '-6.9500147', '107.6645775', 'Test Input Baru', 5, '2021-07-02 07:46:04'),
(41, '-6.9500521', '107.6646329', 'Test Input Baru', 5, '2021-07-02 07:46:56'),
(42, '-6.951457', '107.6656168', 'Test Input Baru', 5, '2021-07-02 07:47:13'),
(43, '-6.9513884', '107.6654229', 'Test Input Baru', 5, '2021-07-02 07:48:24'),
(44, '-6.9513888', '107.6654176', 'Test Input Baru', 5, '2021-07-02 07:48:35'),
(45, '-6.9513879', '107.665422', 'Test Input Baru', 5, '2021-07-02 07:50:12'),
(46, '-6.9513886', '107.6654239', 'Test Input Baru', 5, '2021-07-02 07:50:22'),
(47, '-6.9513874', '107.6654206', 'Test Input Baru', 5, '2021-07-02 07:50:36'),
(48, '-6.95139', '107.6654259', 'Test Input Baru', 5, '2021-07-02 07:51:04'),
(49, '-6.9513883', '107.6654227', 'Test Input Baru', 5, '2021-07-02 07:51:12'),
(50, '-6.9513878', '107.6654198', 'Test Input Baru', 5, '2021-07-02 07:51:32'),
(51, '-6.9513874', '107.6654201', 'Test Input Baru', 5, '2021-07-02 07:55:03'),
(52, '-6.9513879', '107.6654222', 'Test Input Baru', 5, '2021-07-02 07:56:49'),
(53, '-6.9513892', '107.6654252', 'Test Input Baru', 5, '2021-07-02 07:57:00'),
(54, '-6.9513885', '107.6654235', 'Test Input Baru', 5, '2021-07-02 07:58:19'),
(55, '-6.9513887', '107.6654177', 'Test Input Baru', 5, '2021-07-02 07:58:30'),
(56, '-6.9514453', '107.6656218', 'Test Input Baru', 5, '2021-07-02 08:22:40'),
(57, '-6.9513898', '107.665417', 'Test Input Baru', 5, '2021-07-02 08:24:19'),
(58, '-6.9525223', '107.6687019', 'Test Input Baru', 5, '2021-07-02 09:01:37'),
(59, '-6.9523279', '107.665372', 'Test Input Baru', 5, '2021-07-02 09:02:42'),
(60, '-6.9525223', '107.6687019', 'Test Input Baru', 5, '2021-07-02 09:02:48'),
(61, '-6.969051', '107.6359805', 'Test Input Baru', 5, '2021-07-05 03:29:15'),
(62, '-6.9701383', '107.6380867', 'Test Input Baru', 5, '2021-07-05 03:29:17'),
(63, '-6.9513878', '107.6654212', 'Test Input Baru', 5, '2021-07-05 03:51:30'),
(64, '-6.9513878', '107.6654183', 'Test Input Baru', 5, '2021-07-05 03:51:37'),
(65, '-6.9513887', '107.6654168', 'Test Input Baru', 5, '2021-07-05 03:53:19'),
(66, '-6.9513894', '107.6654161', 'Test Input Baru', 5, '2021-07-05 03:55:09'),
(67, '-6.9513885', '107.6654233', 'Test Input Baru', 5, '2021-07-05 03:56:21'),
(68, '-6.9513896', '107.6654168', 'Test Input Baru', 5, '2021-07-05 03:59:07'),
(69, '-6.9513874', '107.6654203', 'Test Input Baru', 5, '2021-07-05 04:00:11'),
(70, '-6.9513894', '107.6654168', 'Test Input Baru', 5, '2021-07-05 04:04:42'),
(71, '-6.9513898', '107.6654167', 'Test Input Baru', 5, '2021-07-05 04:08:36'),
(72, '-6.9513898', '107.6654166', 'Test Input Baru', 5, '2021-07-05 04:09:49'),
(73, '-6.9513898', '107.6654165', 'Test Input Baru', 5, '2021-07-05 04:14:33'),
(74, '-6.9513898', '107.6654165', 'Test Input Baru', 5, '2021-07-05 04:14:34'),
(75, '-6.9513897', '107.6654166', 'Test Input Baru', 5, '2021-07-05 04:14:41'),
(76, '-6.9513869', '107.6654172', 'Test Input Baru', 5, '2021-07-05 04:15:31'),
(77, '-6.9513892', '107.6654169', 'Test Input Baru', 5, '2021-07-05 04:27:57'),
(78, '-6.9513886', '107.6654166', 'Test Input Baru', 5, '2021-07-05 04:29:17'),
(79, '-6.9513807', '107.6654175', 'Test Input Baru', 5, '2021-07-05 04:30:06'),
(80, '-6.9513897', '107.6654166', 'Test Input Baru', 5, '2021-07-05 04:33:38'),
(81, '-6.9513889', '107.6654163', 'Test Input Baru', 5, '2021-07-05 04:34:43'),
(82, '-6.9513885', '107.6654167', 'Test Input Baru', 5, '2021-07-05 05:00:24'),
(83, '-6.951389', '107.6654169', 'Test Input Baru', 5, '2021-07-05 05:08:58'),
(84, '-6.9513198', '107.666482', 'Test Input Baru', 5, '2021-07-05 05:13:00'),
(85, '-6.9517993', '107.6657678', 'Test Input Baru', 5, '2021-07-05 05:15:10'),
(86, '-6.9514411', '107.6655238', 'Test Input Baru', 5, '2021-07-05 05:20:40'),
(87, '-6.9514411', '107.6655238', 'Test Input Baru', 5, '2021-07-05 05:21:04'),
(88, '-6.9514411', '107.6655238', 'Test Input Baru', 5, '2021-07-05 05:22:53'),
(89, '-6.9514411', '107.6655238', 'Test Input Baru', 5, '2021-07-05 05:23:23'),
(90, '-6.9514411', '107.6655238', 'Test Input Baru', 5, '2021-07-05 05:25:01'),
(91, '-6.9513894', '107.6654168', 'Test Input Baru', 5, '2021-07-05 05:30:10'),
(92, '-6.9513887', '107.6654167', 'Test Input Baru', 5, '2021-07-05 05:30:19'),
(93, '-6.9513884', '107.6654196', 'Test Input Baru', 5, '2021-07-05 05:32:13'),
(94, '-6.9513884', '107.6654208', 'Test Input Baru', 5, '2021-07-05 05:32:19'),
(95, '-6.9513884', '107.6654208', 'Test Input Baru', 5, '2021-07-05 05:32:21'),
(96, '-6.9513887', '107.6654168', 'Test Input Baru', 5, '2021-07-05 05:32:51'),
(97, '-6.951391', '107.665428', 'Test Input Baru', 5, '2021-07-05 05:33:19'),
(98, '-6.9514411', '107.6655238', 'Test Input Baru', 5, '2021-07-05 05:33:30'),
(99, '-6.9513882', '107.6654165', 'Test Input Baru', 5, '2021-07-05 05:33:33'),
(100, '-6.9514411', '107.6655238', 'Test Input Baru', 5, '2021-07-05 05:36:25'),
(101, '-6.9513933', '107.6654189', 'Test Input Baru', 5, '2021-07-05 05:40:51'),
(102, '-6.9513902', '107.6654101', 'Test Input Baru', 5, '2021-07-05 05:41:31'),
(103, '-6.9513893', '107.6654101', 'Test Input Baru', 5, '2021-07-05 05:42:11'),
(104, '-6.9513893', '107.6654101', 'Test Input Baru', 5, '2021-07-05 05:43:24'),
(105, '-6.9513893', '107.6654101', 'Test Input Baru', 5, '2021-07-05 05:44:30'),
(106, '-6.9513893', '107.6654101', 'Test Input Baru', 5, '2021-07-05 05:44:51'),
(107, '-6.9513901', '107.6654103', 'Test Input Baru', 5, '2021-07-05 05:52:02'),
(108, '-6.9711809', '107.6334526', 'Test Input Baru', 5, '2021-07-05 08:20:48'),
(109, '-6.9513873', '107.6654158', 'Test Input Baru', 5, '2021-07-05 09:18:25'),
(110, '-6.9513869', '107.66542', 'Test Input Baru', 5, '2021-07-05 09:18:40'),
(111, '-6.9513891', '107.6654174', 'Test Input Baru', 5, '2021-07-05 09:18:56'),
(112, '-6.9513896', '107.6654168', 'Test Input Baru', 5, '2021-07-05 09:20:40'),
(113, '-6.9513889', '107.6654168', 'Test Input Baru', 5, '2021-07-05 09:20:44'),
(114, '-6.9513887', '107.6654168', 'Test Input Baru', 5, '2021-07-05 09:21:11'),
(115, '-6.9513887', '107.6654168', 'Test Input Baru', 5, '2021-07-05 09:21:20'),
(116, '-6.9513893', '107.6654245', 'Test Input Baru', 5, '2021-07-05 09:22:37'),
(117, '-6.9513901', '107.6654154', 'Test Input Baru', 5, '2021-07-05 09:27:21'),
(118, '-6.9698552', '107.6344776', 'Test Input Baru', 5, '2021-07-05 12:29:47'),
(119, '-6.9698443', '107.6344743', 'Test Input Baru', 5, '2021-07-05 12:30:13'),
(120, '-6.9698443', '107.6344743', 'Test Input Baru', 5, '2021-07-05 12:30:23'),
(121, '-6.9698443', '107.6344743', 'Test Input Baru', 5, '2021-07-05 12:30:26'),
(122, '-6.9698443', '107.6344743', 'Test Input Baru', 5, '2021-07-05 12:30:28'),
(123, '-6.9698443', '107.6344743', 'Test Input Baru', 5, '2021-07-05 12:30:40'),
(124, '-6.9698443', '107.6344743', 'Test Input Baru', 5, '2021-07-05 12:30:42'),
(125, '-6.8937225', '107.5714717', 'Test Input Baru', 5, '2021-07-06 05:10:55'),
(126, '-6.8936991', '107.57154', 'Test Input Baru', 5, '2021-07-06 05:11:10'),
(127, '-6.8937037', '107.5715446', 'Test Input Baru', 5, '2021-07-06 05:11:16'),
(128, '-6.8936876', '107.5715009', 'Test Input Baru', 5, '2021-07-06 08:08:36'),
(129, '-6.8936538', '107.5715878', 'Test Input Baru', 5, '2021-07-06 08:11:10'),
(130, '-6.8936875', '107.5715413', 'Test Input Baru', 5, '2021-07-06 08:11:14'),
(131, '-6.8933843', '107.5707628', 'Test Input Baru', 5, '2021-07-06 09:18:25'),
(132, '-6.8933843', '107.5707628', 'Test Input Baru', 5, '2021-07-06 09:18:28'),
(133, '-6.8938543', '107.5714352', 'Test Input Baru', 5, '2021-07-06 09:18:55'),
(134, '-6.8938543', '107.5714352', 'Test Input Baru', 5, '2021-07-06 09:18:58'),
(135, '-6.8914464', '107.5731952', 'Test Input Baru', 5, '2021-07-06 09:24:19'),
(136, '-6.8936861', '107.571556', 'Test Input Baru', 5, '2021-07-06 10:08:16'),
(137, '-6.8937146', '107.5714662', 'Test Input Baru', 5, '2021-07-06 10:52:23'),
(138, '-6.8933843', '107.5707628', 'Test Input Baru', 5, '2021-07-06 11:38:56'),
(139, '-6.8933843', '107.5707628', 'Test Input Baru', 5, '2021-07-06 11:44:30'),
(140, '-6.8925951', '107.5717533', 'Test Input Baru', 5, '2021-07-06 11:44:33'),
(141, '-6.8922086', '107.5722386', 'Test Input Baru', 5, '2021-07-06 11:44:43'),
(142, '-6.8941203', '107.571247', 'Test Input Baru', 5, '2021-07-06 11:45:05'),
(143, '-6.8926784', '107.5730821', 'Test Input Baru', 5, '2021-07-06 12:38:09'),
(144, '-6.8914464', '107.5731952', 'Test Input Baru', 5, '2021-07-06 12:50:33'),
(145, '-6.8925323', '107.5733189', 'Test Input Baru', 5, '2021-07-06 12:50:58'),
(146, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 12:51:29'),
(147, '-6.8927562', '107.5732607', 'Test Input Baru', 5, '2021-07-06 12:54:46'),
(148, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 12:55:12'),
(149, '-6.8914414', '107.5740005', 'Test Input Baru', 5, '2021-07-06 12:55:37'),
(150, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 12:56:17'),
(151, '-6.8914414', '107.5740005', 'Test Input Baru', 5, '2021-07-06 12:56:43'),
(152, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 12:57:28'),
(153, '-6.8914833', '107.5728909', 'Test Input Baru', 5, '2021-07-06 12:58:08'),
(154, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 12:58:43'),
(155, '-6.8914414', '107.5740005', 'Test Input Baru', 5, '2021-07-06 12:59:03'),
(156, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 13:00:14'),
(157, '-6.8927562', '107.5732607', 'Test Input Baru', 5, '2021-07-06 13:00:34'),
(158, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 13:01:08'),
(159, '-6.8914414', '107.5740005', 'Test Input Baru', 5, '2021-07-06 13:01:18'),
(160, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 13:02:33'),
(161, '-6.8914414', '107.5740005', 'Test Input Baru', 5, '2021-07-06 13:02:53'),
(162, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 13:04:08'),
(163, '-6.8914833', '107.5728909', 'Test Input Baru', 5, '2021-07-06 13:04:28'),
(164, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 13:04:53'),
(165, '-6.8914414', '107.5740005', 'Test Input Baru', 5, '2021-07-06 13:05:29'),
(166, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 13:06:49'),
(167, '-6.8934973', '107.5706717', 'Test Input Baru', 5, '2021-07-06 13:07:05');

-- --------------------------------------------------------

--
-- Struktur dari tabel `master_driver`
--
...
--
-- Dumping data untuk tabel `master_driver`
--

INSERT INTO `master_driver` (`id`, `karyawan_id`, `spv_id`, `username`, `password`) VALUES
(5, 13, 3, 'afrizal', '21232f297a57a5a743894a0e4a801fc3'),
(6, 17, 3, 'ipik', '21232f297a57a5a743894a0e4a801fc3');
...
CREATE TABLE `master_items` (
  ...
  `sales_journal` int(11) DEFAULT NULL,
  `sales_journal_lawan` int(11) NOT NULL,
  `hpp_journal` int(11) DEFAULT NULL,
...
(1, 'Layanan Reguler', NULL, 'Domestic', 'Akomodasi', NULL, 89, 66, 99, 17, 0),
(2, 'Layanan COD', NULL, 'Umrah', 'Akomodasi', NULL, 90, 66, 100, 17, 0);
...
CREATE TABLE `master_karyawan` (
  ...
  `sim_a` varchar(50) NOT NULL,
  `sim_c` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `master_karyawan` (`id`, `nik`, `nama`, `hp`, `alamat`, `sim_a`, `sim_c`) VALUES
(7, '123', 'Nanang', '0812', 'Jl. Citarum, Slawi, Tegal', '12', '14'),
(8, '124', 'Andri', '081', 'gedongan', '12', '14'),
(9, '1245', 'Neng Hartini', '0812', 'Jl Saturnus', '15', '13'),
(10, '1245', 'Lusiati', '0812', 'Jl Saturnus 5', '15', '17'),
(11, '1111', 'Armen boy', '0812', 'Painan', '15', '13'),
(12, '2222', 'Masrur', '0812', 'Padang', '15', '17'),
(13, '3333', 'Afrizal', '0812', 'Balaiselasa', '15', '15'),
(14, '4444', 'Dwianto', '081', 'Tarusan', '15', '17'),
(15, '5555', 'Riko', '0812', 'Pasarkambang', '15', '17'),
(16, 'SDFJGKHB', 'KOYO', '0888129348', 'jl imah ditendeun', '123764', '2073456'),
(17, '123', 'IPIK', '08511', 'MAJALAYA', '12', '123');

-- --------------------------------------------------------

--
-- Struktur dari tabel `master_kendaraan`
--
...
--
-- Dumping data untuk tabel `master_kendaraan`
--

INSERT INTO `master_kendaraan` (`id`, `nopol`, `nomesin`, `merk`, `cc`, `tahun_kendaraan`) VALUES
(2, 'D 1111 AE', '1111111', 'Toyota', 2000, 2020),
(3, 'D 8481 VV', '09988', 'MITSUBISHI 125 PS', 3000, 2015);
...
INSERT INTO `master_pelanggan` (`id_pelanggan`, `nama`, `telepon`, `alamat`, `id_provinsi`, `id_kota`, `id_kecamatan`) VALUES
('CST0001', 'ASTRA OTOPART', '02177744456', 'JL Permata Raya, Kawasan Industri KIIC, Lot BB/4A, Karawang, Jawa Barat', 51, 5103, 5103020),
('CST0002', 'Asep', '081325567890', 'Bandung', 51, 5103, 5103020),
('CST0003', 'asdada', '345345', 'asdasd', 51, 5103, 5103020),
('CST0004', 'Pelanggan Coba', '02177744456', 'Yogya', 34, 3402, 3402100),
('CST0005', 'Andri Kurniawan', '081323268184', 'Ujung Berung', 11, 1107, 1107062),
('CST0006', 'dita', '6281546959913', 'd', 32, 3204, 3204150);

-- --------------------------------------------------------

--
-- Struktur dari tabel `master_pool`
--

CREATE TABLE `master_pool` (
  `id_pool` varchar(10) NOT NULL,
  `nama_pool` varchar(30) NOT NULL,
  `telepon_pool` varchar(15) NOT NULL,
  `alamat_pool` varchar(150) NOT NULL,
  `hargakg` double NOT NULL,
  `id_provinsi` int(11) NOT NULL,
  `id_kota` int(11) NOT NULL,
  `id_kecamatan` int(11) NOT NULL,
  `jenis_tujuan` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

--
-- Dumping data untuk tabel `master_pool`
--

INSERT INTO `master_pool` (`id_pool`, `nama_pool`, `telepon_pool`, `alamat_pool`, `hargakg`, `id_provinsi`, `id_kota`, `id_kecamatan`, `jenis_tujuan`) VALUES
('POOL0001', 'Huda', '089900786657', 'Solo', 10000, 33, 3313, 3313090, NULL),
('POOL0002', 'Ahmad', '089976554676', 'Tegal', 20000, 31, 3174, 3174070, NULL),
('POOL0003', 'Tanah Abang', '9876543210', 'aaaaaaa', 100000, 31, 3174, 3174070, NULL),
('POOL0004', 'Pool Tanah Abang', '08', 'Pool Tanah Abang', 1000, 31, 3174, 3174070, NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `master_spv`
--

CREATE TABLE `master_spv` (
  `id` int(11) NOT NULL,
  `karyawan_id` varchar(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

--
-- Dumping data untuk tabel `master_spv`
--

INSERT INTO `master_spv` (`id`, `karyawan_id`) VALUES
(4, '11'),
(3, '12'),
(5, '16');
...
CREATE TABLE `master_tarif` (
  `id_tarif` varchar(7) CHARACTER SET latin1 NOT NULL,
  `id_jenis_layanan` varchar(10) CHARACTER SET latin1 NOT NULL,
  `id_kecamatan_asal` char(10) CHARACTER SET latin1 NOT NULL,
  `id_kecamatan_tujuan` char(10) CHARACTER SET latin1 NOT NULL,
  `berat_tarif` int(11) NOT NULL,
...
INSERT INTO `master_tarif` (`id_tarif`, `id_jenis_layanan`, `id_kecamatan_asal`, `id_kecamatan_tujuan`, `berat_tarif`, `harga_tarif`) VALUES
('TRF0002', 'COD', '1703073', '3601090', 1, 200000);
...
INSERT INTO `master_tujuan` (`id_tujuan`, `nama_tujuan`, `telepon_tujuan`, `alamat_tujuan`, `hargakg`, `id_provinsi`, `id_kota`, `id_kecamatan`, `jenis_tujuan`, `tarif`) VALUES
('TJAN0001', 'POOL 1', '0812555', 'A', 0, 31, 3174, 3174070, 'Pool', 10000),
('TJAN0002', 'POOL 2', '081244', 'B', 0, 31, 3174, 3174070, 'Pool', 10000),
('TJAN0003', 'POOL 3', '0812566', 'C', 0, 31, 3174, 3174080, 'Pool', 10000),
('TJAN0004', 'TOKO 1', '081244', 'TOKO 1', 0, 31, 3174, 3174070, 'Toko', 10000),
('TJAN0005', 'TOKO 2', '0812455', 'TOKO 2', 0, 31, 3174, 3174070, 'Toko', 10000),
('TJAN0006', 'TOKO 3', '081524', 'TOKO 3', 0, 31, 3174, 3174080, 'Toko', 10000),
('TJAN0007', 'EKSPEDISI 1', '0815', 'EKSPEDISI 1', 0, 31, 3174, 3174040, 'Ekspedisi', 10000),
('TJAN0008', 'EKSPEDISI 2', '081254', 'EKSPEDISI 2', 0, 31, 3174, 3174070, 'Ekspedisi', 10000),
('TJAN0009', 'JATINEGARA', '08', 'JATINEGARA', 0, 31, 3172, 3172060, 'Pool', 10000),
('TJAN0010', 'TANAH ABANG', '08', 'TANAH ABANG', 0, 31, 3173, 3173010, 'Pool', 10000),
('TJAN0011', 'PASAR PAGI', '08', 'PASAR PAGI', 0, 31, 3174, 3174060, 'Pool', 10000),
('TJAN0012', 'CIPULIR', '08', 'CIPULIR', 0, 31, 3171, 3171040, 'Pool', 10000),
('TJAN0013', 'POOL CENGKARENG', '085214', 'Cengkareng', 0, 31, 3174, 3174070, 'Pool', 10000),
('TJAN0014', 'POOL PRIOK', '08521', 'POOL PRIOK', 0, 31, 3173, 3173050, 'Pool', 10000),
('TJAN0015', 'POOL JAKARTA TIMUR', '08521', 'JAKARTA TIMUR', 0, 31, 3172, 3172070, 'Pool', 10000),
('TJAN0016', 'POOL 10', '08531', 'A', 0, 31, 3173, 3173040, 'Pool', 10000);

-- --------------------------------------------------------

--
-- Struktur dari tabel `pembayaran_amplop_detail`
--

CREATE TABLE `pembayaran_amplop_detail` (
  `no_cicil_bayar_amplop` int(11) NOT NULL,
  `no_bayar_amplop` int(11) NOT NULL,
  `tanggal_bayar_amplop` varchar(10) NOT NULL,
  `nominal` int(11) NOT NULL,
  `jenis_cara_bayar` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

-- --------------------------------------------------------

--
-- Struktur dari tabel `pembayaran_jenis`
--

CREATE TABLE `pembayaran_jenis` (
  `id` int(11) NOT NULL,
  `jenis_nama` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `ref_kecamatan` (`id_kecamatan`, `kota_id`, `nama_kecamatan`) VALUES
...
INSERT INTO `ref_kota` (`id_kota`, `provinsi_id`, `nama_kota`) VALUES
...
--
-- Struktur dari tabel `status_katalog`
--

CREATE TABLE `status_katalog` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_transaction_detail`
--
...
--
-- Struktur dari tabel `transaction_journal`
--
...
--
-- Dumping data untuk tabel `transaction_journal`
--
...
(3, '001/RAN/INV/180816', '2018-08-16', 'sales', 'Invoice #001/RAN/INV/180816', '', '66', 0, 8000000, 0, 'admin', 0, NULL, 1),
(4, '001/RAN/INV/180816', '2018-08-16', 'sales', 'Invoice #001/RAN/INV/180816', '', '95', 0, 0, 0, 'admin', 0, NULL, 1),
(5, '001/RAN/INV/180816', '2018-08-16', 'sales', 'Tiket Pesawat Garuda', '', '89', 0, 0, 8000000, 'admin', 0, NULL, 1),
(6, '001/RAN/INV/180816', '2018-08-16', 'sales', 'HPP - Tiket Pesawat Garuda', '', '99', 0, 3000000, 0, 'admin', 0, NULL, 1),
(7, '001/RAN/INV/180816', '2018-08-16', 'sales', 'HPP - Tiket Pesawat Garuda', '', '17', 0, 0, 3000000, 'admin', 0, NULL, 1),
(8, '019/RAN/INV/180816', '2018-01-26', 'sales', 'Invoice #019/RAN/INV/180816', '', '66', 0, 8000000, 0, 'admin', 0, NULL, 1),
(9, '019/RAN/INV/180816', '2018-01-26', 'sales', 'Invoice #019/RAN/INV/180816', '', '95', 0, 0, 0, 'admin', 0, NULL, 1),
(10, '019/RAN/INV/180816', '2018-01-26', 'sales', 'Tiket Pesawat Garuda', '', '89', 0, 0, 8000000, 'admin', 0, NULL, 1),
(11, '019/RAN/INV/180816', '2018-01-26', 'sales', 'HPP - Tiket Pesawat Garuda', '', '99', 0, 3000000, 0, 'admin', 0, NULL, 1),
(12, '019/RAN/INV/180816', '2018-01-26', 'sales', 'HPP - Tiket Pesawat Garuda', '', '17', 0, 0, 3000000, 'admin', 0, NULL, 1),
(13, 'RAN180816214628', '2018-01-03', 'pengeluaran', 'Dibeli tunai peralatan toko Rp 1 juta', 'BKK-18001', '66', 2, 0, 3000000, 'admin', 0, '2018-08-16 14:47:09', 0),
...
(0, 'RAN180816214628', '2018-01-03', 'pengeluaran', 'aa', 'BKK-18001', '66', 2, 2000000, 3000000, 'admin', 0, '2021-04-01 05:33:57', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaction_journal_header`
--
...
--
-- Dumping data untuk tabel `transaction_journal_header`
--
...
(0, 'RAN210331150606', 0, 0, 'VCU-2103005', '2021-03-31', 'aa', 1, 'jurnal_umum', 1),
(0, 'RAN210331150606', 0, 0, 'VCU-2103005', '2021-03-31', 'aa', 1, 'jurnal_umum', 1),
(0, 'RAN210331150703', 0, 0, 'VCU-2103005', '2021-03-31', 'a', 1, 'jurnal_umum', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaksi_pembayaran_amplop`
--

CREATE TABLE `transaksi_pembayaran_amplop` (
  `no_bayar_amplop` int(11) NOT NULL,
  `id_pelanggan` varchar(7) NOT NULL,
  `tanggal_bayar_amplop` date DEFAULT NULL,
  `id_amplop` varchar(15) NOT NULL,
...
--
-- Struktur dari tabel `transaksi_surat_jalan`
--

CREATE TABLE `transaksi_surat_jalan` (
  `id_surat_jalan` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `transaksi_surat_jalan`
--

INSERT INTO `transaksi_surat_jalan` (`id_surat_jalan`, `tanggal`, `id_driver`, `id_kendaraan`, `keterangan`, `penerima`, `photo`, `status`) VALUES
('SPB20210001', '2021-07-03', '6', '2', NULL, NULL, NULL, 1),
('SPB20210002', '2021-07-03', '6', '2', NULL, NULL, NULL, 1);

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaksi_surat_jalan_detail`
--

CREATE TABLE `transaksi_surat_jalan_detail` (
  `id_detail` int(11) NOT NULL,
  `id_surat_jalan` varchar(20) NOT NULL,
  `id_amplop` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

--
-- Dumping data untuk tabel `transaksi_surat_jalan_detail`
--

INSERT INTO `transaksi_surat_jalan_detail` (`id_detail`, `id_surat_jalan`, `id_amplop`) VALUES
(15, 'SPB20210001', 'TTB20210001'),
(16, 'SPB20210001', 'TTB20210002'),
(17, 'SPB20210002', 'TTB20210003'),
(18, 'SPB20210002', 'TTB20210004');

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaksi_ttb`
--

CREATE TABLE `transaksi_ttb` (
  `id_amplop` varchar(20) NOT NULL,
  `tanggal` date NOT NULL,
  `id_pelanggan` varchar(10) NOT NULL,
  `id_tujuan` varchar(10) NOT NULL,
  `berat_amplop` int(11) NOT NULL,
  `jenis_kirim` varchar(20) NOT NULL,
  `jenis_bayar` varchar(20) NOT NULL,
  `id_tarif` varchar(7) NOT NULL,
  `ongkos_kirim` double NOT NULL,
  `ongkos_bongkar` double NOT NULL,
  `diskon` int(11) NOT NULL,
  `ongkos_bersih` double NOT NULL,
  `bayar_amplop` double NOT NULL,
  `kembalian_amplop` double NOT NULL,
  `keterangan` varchar(150) DEFAULT NULL,
  `photo` varchar(200) DEFAULT NULL,
  `satuan` varchar(255) DEFAULT NULL,
  `nama_pengirim` varchar(255) DEFAULT NULL,
  `alamat_pengirim` varchar(255) DEFAULT NULL,
  `hp_pengirim` varchar(255) DEFAULT NULL,
  `nama_penerima` varchar(255) DEFAULT NULL,
  `alamat_penerima` varchar(255) DEFAULT NULL,
  `hp_penerima` varchar(255) DEFAULT NULL,
  `status` int(11) NOT NULL COMMENT 'order, deal, kirim, berhasil, retur',
  `tarif` int(11) DEFAULT NULL,
  `provinsi` varchar(30) NOT NULL,
  `kota` varchar(30) NOT NULL,
  `kecamatan` varchar(30) NOT NULL,
  `status_delete` char(1) DEFAULT NULL,
  `mobile_driver_ditolak_alasan` varchar(255) DEFAULT NULL,
  `mobile_driver_diterima_nama` varchar(150) DEFAULT NULL,
  `mobile_driver_diterima_foto` varchar(100) DEFAULT NULL,
  `mobile_driver_diterima_ttd` varchar(200) DEFAULT NULL,
  `mobile_driver_diterima_jenis_penerima` varchar(50) DEFAULT NULL,
  `mobile_driver_pengantar` varchar(50) DEFAULT NULL,
  `mobile_driver_mandor` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC;

--
-- Dumping data untuk tabel `transaksi_ttb`
--

INSERT INTO `transaksi_ttb` (`id_amplop`, `tanggal`, `id_pelanggan`, `id_tujuan`, `berat_amplop`, `jenis_kirim`, `jenis_bayar`, `id_tarif`, `ongkos_kirim`, `ongkos_bongkar`, `diskon`, `ongkos_bersih`, `bayar_amplop`, `kembalian_amplop`, `keterangan`, `photo`, `satuan`, `nama_pengirim`, `alamat_pengirim`, `hp_pengirim`, `nama_penerima`, `alamat_penerima`, `hp_penerima`, `status`, `tarif`, `provinsi`, `kota`, `kecamatan`, `status_delete`, `mobile_driver_ditolak_alasan`, `mobile_driver_diterima_nama`, `mobile_driver_diterima_foto`, `mobile_driver_diterima_ttd`, `mobile_driver_diterima_jenis_penerima`, `mobile_driver_pengantar`, `mobile_driver_mandor`) VALUES
('TTB20210001', '2021-07-03', 'CST0001', 'TJAN0001', 1, 'COD', 'CASH', '', 10000, 0, 0, 10000, 0, -10000, NULL, NULL, 'Bal', 'ASTRA OTOPART', 'JL Permata Raya, Kawasan Industri KIIC, Lot BB/4A, Karawang, Jawa Barat', '02177744456', 'Andri', 'a', '0812', 2, 10000, '', '', '', '1', NULL, 'yusuf', NULL, NULL, 'Sahabat Selamanya', 'IPIK', ''),
('TTB20210002', '2021-07-03', 'CST0001', 'TJAN0001', 1, 'COD', 'CASH', '', 10000, 0, 0, 10000, 0, -10000, NULL, NULL, 'Bal', 'ASTRA OTOPART', 'JL Permata Raya, Kawasan Industri KIIC, Lot BB/4A, Karawang, Jawa Barat', '02177744456', 'Pinan', 'a', '0812', 2, 10000, '', '', '', '1', NULL, 'NURIL', NULL, NULL, 'Temen Dekat', 'IPIK', ''),
('TTB20210003', '2021-07-03', 'CST0005', 'TJAN0001', 1, 'COD', 'CASH', '', 10000, 0, 0, 10000, 0, -10000, NULL, NULL, 'Bal', 'Andri Kurniawan', 'Ujung Berung', '081323268184', 'Pinan', 'Bandung', '0812', 2, 10000, '', '', '', '1', 'barang rusak', 'Padhisa ', NULL, NULL, 'Temen Dekat', 'IPIK', ''),
('TTB20210004', '2021-07-03', 'CST0001', 'TJAN0001', 1, 'COD', 'CASH', '', 10000, 0, 0, 10000, 0, -10000, NULL, NULL, 'Bal', 'ASTRA OTOPART', 'JL Permata Raya, Kawasan Industri KIIC, Lot BB/4A, Karawang, Jawa Barat', '02177744456', 'Andri', 'a', '0812', 2, 10000, '', '', '', '1', NULL, 'Padhisa ', NULL, NULL, 'Sahabat Selamanya', 'IPIK', ''),
('TTB20210005', '2021-07-05', 'CST0001', 'TJAN0001', 1, 'COD', 'CASH', '', 10000, 0, 0, 10000, 0, -10000, NULL, NULL, 'Bal', 'ASTRA OTOPART', 'JL Permata Raya, Kawasan Industri KIIC, Lot BB/4A, Karawang, Jawa Barat', '02177744456', 'Pinan dhita', 'a', '081', 2, 10000, '', '', '', '1', NULL, NULL, NULL, NULL, NULL, NULL, '');

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaksi_ttb_history`
--

CREATE TABLE `transaksi_ttb_history` (
  `id` int(11) NOT NULL,
  `id_amplop` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `transaksi_ttb_history`
--

INSERT INTO `transaksi_ttb_history` (`id`, `id_amplop`, `tanggal`, `waktu`, `location`, `pic_driver`, `status`, `keterangan`, `create_date`, `status_delete`) VALUES
(40, 'TTB20210001', '2021-07-03', '15:51:17', 'Majalaya', '', '1', NULL, '2021-07-03 08:51:17', 1),
(41, 'TTB20210002', '2021-07-03', '15:51:35', 'Majalaya', '', '1', NULL, '2021-07-03 08:51:35', 1),
(42, 'TTB20210001', '2021-07-03', '15:51:49', 'Perjalanan Menuju Pool', '', 'Dikirim', NULL, '2021-07-03 08:51:49', 1),
(43, 'TTB20210002', '2021-07-03', '15:51:49', 'Perjalanan Menuju Pool', '', 'Dikirim', NULL, '2021-07-03 08:51:49', 1),
(44, 'TTB20210003', '2021-07-03', '16:21:43', 'Majalaya', '', '1', NULL, '2021-07-03 09:21:43', 1),
(45, 'TTB20210004', '2021-07-03', '16:32:42', 'Majalaya', '', '1', NULL, '2021-07-03 09:32:42', 1),
(46, 'TTB20210003', '2021-07-03', '16:34:05', 'Perjalanan Menuju Pool', '', 'Dikirim', NULL, '2021-07-03 09:34:05', 1),
(47, 'TTB20210004', '2021-07-03', '16:34:05', 'Perjalanan Menuju Pool', '', 'Dikirim', NULL, '2021-07-03 09:34:05', 1),
(48, 'TTB20210005', '2021-07-05', '14:38:53', 'Masih Di Pegirim', '', '0', NULL, '2021-07-05 07:38:53', 1);
...
('USR02', 'finance', '21232f297a57a5a743894a0e4a801fc3', 2),
('USR03', 'gudang', '21232f297a57a5a743894a0e4a801fc3', 3),
('USR04', 'spv', '21232f297a57a5a743894a0e4a801fc3', 4);

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `v_daftar_piutang`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_daftar_piutang` (
`id_piutang` int(11)
,`coa` varchar(255)
,`id_pelanggan` varchar(255)
,`tgl_transaksi` date
,`id_amplop` varchar(255)
,`jumlah_piutang` int(11)
,`jumlah_bayar` int(11)
...
--
-- Stand-in struktur untuk tampilan `v_dashboard_mobile_driver`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_dashboard_mobile_driver` (
`id_driver` varchar(5)
,`nama_driver` varchar(50)
,`nopol` varchar(64)
,`TotalDikirim` bigint(21)
,`TotalProses` bigint(21)
,`TotalBerhasil` bigint(21)
,`TotalRetur` bigint(21)
);

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `v_driver`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Stand-in struktur untuk tampilan `v_lokasi`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Stand-in struktur untuk tampilan `v_mobile_driver_dikirim`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_mobile_driver_dikirim` (
`id_driver` varchar(5)
,`mandor` varchar(50)
,`id_amplop` varchar(20)
,`jumlah_order` int(11)
,`nama_pengirim` varchar(255)
,`tujuan` varchar(30)
,`alamat_tujuan` varchar(150)
...
--
-- Stand-in struktur untuk tampilan `v_mobile_driver_proses`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_mobile_driver_proses` (
`id_driver` varchar(5)
,`id_amplop` varchar(20)
,`jumlah_order` int(11)
,`nama_pengirim` varchar(255)
...
--
-- Stand-in struktur untuk tampilan `v_mobile_driver_retur`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_mobile_driver_retur` (
`id_driver` varchar(5)
,`id_amplop` varchar(20)
,`jumlah_order` int(11)
,`nama_pengirim` varchar(255)
...
--
-- Stand-in struktur untuk tampilan `v_mobile_driver_sukses`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_mobile_driver_sukses` (
`id_driver` varchar(5)
,`mandor` varchar(50)
,`id_amplop` varchar(20)
,`jumlah_order` int(11)
...
,`id_tarif` varchar(7)
,`ongkos_kirim` double
,`ongkos_bongkar` double
,`diskon` int(11)
,`ongkos_bersih` double
,`bayar_amplop` double
,`kembalian_amplop` double
,`keterangan` varchar(150)
,`photo` varchar(200)
,`satuan` varchar(255)
,`nama_pengirim` varchar(255)
,`alamat_pengirim` varchar(255)
,`hp_pengirim` varchar(255)
,`nama_penerima` varchar(255)
,`alamat_penerima` varchar(255)
,`hp_penerima` varchar(255)
,`status` int(11)
,`tarif` int(11)
,`provinsi` varchar(30)
,`kota` varchar(30)
,`kecamatan` varchar(30)
,`status_delete` char(1)
,`mobile_driver_ditolak_alasan` varchar(255)
,`mobile_driver_diterima_nama` varchar(150)
,`mobile_driver_diterima_foto` varchar(100)
,`mobile_driver_diterima_ttd` varchar(200)
,`mobile_driver_diterima_jenis_penerima` varchar(50)
,`mobile_driver_pengantar` varchar(50)
...
--
-- Stand-in struktur untuk tampilan `v_spb`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_spb` (
`id_surat_jalan` varchar(20)
,`id_amplop` varchar(20)
,`tanggal` date
,`id_driver` varchar(5)
...
,`alasan` varchar(255)
,`nopol` varchar(64)
,`nik_driver` varchar(11)
,`hp_driver` varchar(20)
,`nama_pengirim` varchar(255)
,`alamat_pengirim` varchar(255)
,`nama_penerima` varchar(255)
,`alamat_penerima` varchar(255)
...
--
-- Stand-in struktur untuk tampilan `v_spb1`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_spb1` (
`id_surat_jalan` varchar(20)
...
--
-- Stand-in struktur untuk tampilan `v_ttb`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `v_ttb` (
`id_amplop` varchar(20)
...
--
-- Struktur untuk view `v_daftar_piutang`
--
DROP TABLE IF EXISTS `v_daftar_piutang`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_daftar_piutang`  AS SELECT `a`.`id_piutang` AS `id_piutang`, `a`.`coa` AS `coa`, `a`.`id_pelanggan` AS `id_pelanggan`, `a`.`tgl_transaksi` AS `tgl_transaksi`, `a`.`id_amplop` AS `id_amplop`, `a`.`jumlah_piutang` AS `jumlah_piutang`, `a`.`jumlah_bayar` AS `jumlah_bayar`, `a`.`keterangan` AS `keterangan`, `a`.`status` AS `status`, `a`.`sisa_piutang` AS `sisa_piutang`, `b`.`nama` AS `nama`, `b`.`telepon` AS `telepon`, `b`.`alamat` AS `alamat` FROM (`daftar_piutang` `a` left join `master_pelanggan` `b` on(`b`.`id_pelanggan` = `a`.`id_pelanggan`)) WHERE `a`.`status` = 'belum lunas' ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_dashboard_mobile_driver`
--
DROP TABLE IF EXISTS `v_dashboard_mobile_driver`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_dashboard_mobile_driver`  AS SELECT `v_spb`.`id_driver` AS `id_driver`, `v_spb`.`nama_driver` AS `nama_driver`, `v_spb`.`nopol` AS `nopol`, count(`v_spb`.`status`) AS `TotalDikirim`, count(case when `v_spb`.`status` = 2 then 1 end) AS `TotalProses`, count(case when `v_spb`.`status` = 3 then 1 end) AS `TotalBerhasil`, count(case when `v_spb`.`status` = 4 then 1 end) AS `TotalRetur` FROM `v_spb` GROUP BY `v_spb`.`id_driver` ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_driver`
--
DROP TABLE IF EXISTS `v_driver`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_driver`  AS SELECT SQL_CALC_FOUND_ROWS `pg`.`id` AS `id`, `pg`.`karyawan_id` AS `karyawan_id`, `pg`.`spv_id` AS `spv_id`, `pg`.`username` AS `username`, `pg`.`password` AS `password`, `p`.`nama` AS `nama`, `p`.`alamat` AS `alamat`, `p`.`hp` AS `hp`, `p`.`nik` AS `nik`, `q`.`nama` AS `spv` FROM (((`master_driver` `pg` left join `master_karyawan` `p` on(`p`.`id` = `pg`.`karyawan_id`)) left join `master_spv` `a` on(`a`.`id` = `pg`.`spv_id`)) left join `master_karyawan` `q` on(`q`.`id` = `a`.`karyawan_id`)) ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_lokasi`
--
DROP TABLE IF EXISTS `v_lokasi`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_lokasi`  AS SELECT `a`.`id` AS `id`, `a`.`lat` AS `lat`, `a`.`long` AS `long`, `a`.`keterangan` AS `keterangan`, `a`.`driver_id` AS `driver_id`, `a`.`timestemp` AS `timestemp`, `b`.`karyawan_id` AS `karyawan_id`, `b`.`spv_id` AS `spv_id`, `b`.`nama` AS `nama`, `b`.`alamat` AS `alamat` FROM (`lokasi_driver` `a` join `v_driver` `b`) WHERE `a`.`timestemp` in (select max(`lokasi_driver`.`timestemp`) from `lokasi_driver` group by `lokasi_driver`.`driver_id`) AND `a`.`driver_id` = `b`.`id` ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_mobile_driver_dikirim`
--
DROP TABLE IF EXISTS `v_mobile_driver_dikirim`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_mobile_driver_dikirim`  AS SELECT `a`.`id_driver` AS `id_driver`, `a`.`mandor` AS `mandor`, `a`.`id_amplop` AS `id_amplop`, `a`.`berat_amplop` AS `jumlah_order`, `a`.`nama_pengirim` AS `nama_pengirim`, `a`.`nama_tujuan` AS `tujuan`, `a`.`alamat_tujuan` AS `alamat_tujuan`, `a`.`nama_penerima` AS `nama_penerima`, `a`.`keterangan` AS `keterangan`, CASE WHEN `a`.`status` = 2 THEN 'PROSES' WHEN `a`.`status` = 3 THEN 'SUKSES' WHEN `a`.`status` = 4 THEN 'RETUR' END AS `STATUS`, `a`.`nama_driver` AS `driver` FROM `v_spb` AS `a` ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_mobile_driver_proses`
--
DROP TABLE IF EXISTS `v_mobile_driver_proses`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_mobile_driver_proses`  AS SELECT `a`.`id_driver` AS `id_driver`, `a`.`id_amplop` AS `id_amplop`, `a`.`berat_amplop` AS `jumlah_order`, `a`.`nama_pengirim` AS `nama_pengirim`, `a`.`nama_tujuan` AS `tujuan`, `a`.`alamat_tujuan` AS `alamat_tujuan`, `a`.`nama_penerima` AS `nama_penerima`, `a`.`keterangan` AS `keterangan`, CASE WHEN `a`.`status` = 2 THEN 'PROSES' END AS `STATUS`, `a`.`nama_driver` AS `driver` FROM `v_spb` AS `a` WHERE `a`.`status` = 2 ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_mobile_driver_retur`
--
DROP TABLE IF EXISTS `v_mobile_driver_retur`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_mobile_driver_retur`  AS SELECT `a`.`id_driver` AS `id_driver`, `a`.`id_amplop` AS `id_amplop`, `a`.`berat_amplop` AS `jumlah_order`, `a`.`nama_pengirim` AS `nama_pengirim`, `a`.`nama_tujuan` AS `tujuan`, `a`.`alamat_tujuan` AS `alamat_tujuan`, `a`.`nama_penerima` AS `nama_penerima`, `a`.`alasan` AS `alasan`, CASE WHEN `a`.`status` = 4 THEN 'RETUR' END AS `STATUS`, `a`.`nama_driver` AS `driver` FROM `v_spb` AS `a` WHERE `a`.`status` = 4 ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_mobile_driver_sukses`
--
DROP TABLE IF EXISTS `v_mobile_driver_sukses`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_mobile_driver_sukses`  AS SELECT `a`.`id_driver` AS `id_driver`, `a`.`mandor` AS `mandor`, `a`.`id_amplop` AS `id_amplop`, `a`.`berat_amplop` AS `jumlah_order`, `a`.`nama_pengirim` AS `nama_pengirim`, `a`.`nama_tujuan` AS `tujuan`, `a`.`alamat_tujuan` AS `alamat_tujuan`, `a`.`nama_penerima` AS `nama_penerima`, `a`.`keterangan` AS `keterangan`, CASE WHEN `a`.`status` = 3 THEN 'SUKSES' END AS `STATUS`, `a`.`nama_driver` AS `driver` FROM `v_spb` AS `a` WHERE `a`.`status` = 3 ;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_order`  AS SELECT SQL_CALC_FOUND_ROWS `pg`.`id_amplop` AS `id_amplop`, `pg`.`tanggal` AS `tanggal`, `pg`.`id_pelanggan` AS `id_pelanggan`, `pg`.`id_tujuan` AS `id_tujuan`, `pg`.`berat_amplop` AS `berat_amplop`, `pg`.`jenis_kirim` AS `jenis_kirim`, `pg`.`jenis_bayar` AS `jenis_bayar`, `pg`.`id_tarif` AS `id_tarif`, `pg`.`ongkos_kirim` AS `ongkos_kirim`, `pg`.`ongkos_bongkar` AS `ongkos_bongkar`, `pg`.`diskon` AS `diskon`, `pg`.`ongkos_bersih` AS `ongkos_bersih`, `pg`.`bayar_amplop` AS `bayar_amplop`, `pg`.`kembalian_amplop` AS `kembalian_amplop`, `pg`.`keterangan` AS `keterangan`, `pg`.`photo` AS `photo`, `pg`.`satuan` AS `satuan`, `pg`.`nama_pengirim` AS `nama_pengirim`, `pg`.`alamat_pengirim` AS `alamat_pengirim`, `pg`.`hp_pengirim` AS `hp_pengirim`, `pg`.`nama_penerima` AS `nama_penerima`, `pg`.`alamat_penerima` AS `alamat_penerima`, `pg`.`hp_penerima` AS `hp_penerima`, `pg`.`status` AS `status`, `pg`.`tarif` AS `tarif`, `pg`.`provinsi` AS `provinsi`, `pg`.`kota` AS `kota`, `pg`.`kecamatan` AS `kecamatan`, `pg`.`status_delete` AS `status_delete`, `pg`.`mobile_driver_ditolak_alasan` AS `mobile_driver_ditolak_alasan`, `pg`.`mobile_driver_diterima_nama` AS `mobile_driver_diterima_nama`, `pg`.`mobile_driver_diterima_foto` AS `mobile_driver_diterima_foto`, `pg`.`mobile_driver_diterima_ttd` AS `mobile_driver_diterima_ttd`, `pg`.`mobile_driver_diterima_jenis_penerima` AS `mobile_driver_diterima_jenis_penerima`, `pg`.`mobile_driver_pengantar` AS `mobile_driver_pengantar`, `p`.`nama` AS `pelanggan`, `p`.`alamat` AS `alamat` FROM (`transaksi_ttb` `pg` left join `master_pelanggan` `p` on(`p`.`id_pelanggan` = `pg`.`id_pelanggan`)) WHERE `pg`.`status` = 0 ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_spb`
--
DROP TABLE IF EXISTS `v_spb`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_spb`  AS SELECT `a`.`id_surat_jalan` AS `id_surat_jalan`, `a`.`id_amplop` AS `id_amplop`, `b`.`tanggal` AS `tanggal`, `b`.`id_driver` AS `id_driver`, `b`.`id_kendaraan` AS `id_kendaraan`, `c`.`karyawan_id` AS `karyawan_id`, `c`.`spv_id` AS `spv_id`, `d`.`nama` AS `nama_driver`, `f`.`nama_tujuan` AS `nama_tujuan`, `f`.`alamat_tujuan` AS `alamat_tujuan`, `e`.`berat_amplop` AS `berat_amplop`, `e`.`keterangan` AS `keterangan`, `e`.`mobile_driver_mandor` AS `mandor`, `e`.`mobile_driver_ditolak_alasan` AS `alasan`, `g`.`nopol` AS `nopol`, `d`.`nik` AS `nik_driver`, `d`.`hp` AS `hp_driver`, `e`.`nama_pengirim` AS `nama_pengirim`, `e`.`alamat_pengirim` AS `alamat_pengirim`, `e`.`nama_penerima` AS `nama_penerima`, `e`.`alamat_penerima` AS `alamat_penerima`, `e`.`status` AS `status`, `f`.`jenis_tujuan` AS `jenis` FROM ((((((`transaksi_surat_jalan_detail` `a` left join `transaksi_surat_jalan` `b` on(`b`.`id_surat_jalan` = `a`.`id_surat_jalan`)) left join `master_driver` `c` on(`c`.`id` = `b`.`id_driver`)) left join `master_karyawan` `d` on(`d`.`id` = `c`.`karyawan_id`)) left join `transaksi_ttb` `e` on(`e`.`id_amplop` = `a`.`id_amplop`)) left join `master_tujuan` `f` on(`f`.`id_tujuan` = `e`.`id_tujuan`)) left join `master_kendaraan` `g` on(`g`.`id` = `b`.`id_kendaraan`)) ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_spb1`
--
DROP TABLE IF EXISTS `v_spb1`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_spb1`  AS SELECT `v_spb`.`id_surat_jalan` AS `id_surat_jalan`, `v_spb`.`id_amplop` AS `id_amplop`, `v_spb`.`tanggal` AS `tanggal`, `v_spb`.`id_driver` AS `id_driver`, `v_spb`.`id_kendaraan` AS `id_kendaraan`, `v_spb`.`karyawan_id` AS `karyawan_id`, `v_spb`.`spv_id` AS `spv_id`, `v_spb`.`nama_driver` AS `nama_driver`, `v_spb`.`nik_driver` AS `nik_driver`, `v_spb`.`hp_driver` AS `hp_driver`, `v_spb`.`nama_pengirim` AS `nama_pengirim`, `v_spb`.`alamat_pengirim` AS `alamat_pengirim`, `v_spb`.`nama_penerima` AS `nama_penerima`, `v_spb`.`alamat_penerima` AS `alamat_penerima`, `v_spb`.`status` AS `status`, `v_spb`.`jenis` AS `jenis` FROM `v_spb` WHERE `v_spb`.`status` = 2 ORDER BY `v_spb`.`id_amplop` ASC ;

-- --------------------------------------------------------

--
-- Struktur untuk view `v_ttb`
--
DROP TABLE IF EXISTS `v_ttb`;

CREATE ALGORITHM=UNDEFINED DEFINER=`setiatra`@`localhost` SQL SECURITY DEFINER VIEW `v_ttb`  AS SELECT `transaksi_ttb`.`id_amplop` AS `id_amplop`, `transaksi_ttb`.`tanggal` AS `tanggal`, `transaksi_ttb`.`id_pelanggan` AS `id_pelanggan`, `transaksi_ttb`.`id_tujuan` AS `id_tujuan`, `transaksi_ttb`.`berat_amplop` AS `berat_amplop`, `transaksi_ttb`.`jenis_kirim` AS `jenis_kirim`, `transaksi_ttb`.`jenis_bayar` AS `jenis_bayar`, `transaksi_ttb`.`id_tarif` AS `id_tarif`, `transaksi_ttb`.`ongkos_kirim` AS `ongkos_kirim`, `transaksi_ttb`.`ongkos_bongkar` AS `ongkos_bongkar`, `transaksi_ttb`.`diskon` AS `diskon`, `transaksi_ttb`.`ongkos_bersih` AS `ongkos_bersih`, `transaksi_ttb`.`bayar_amplop` AS `bayar_amplop`, `transaksi_ttb`.`kembalian_amplop` AS `kembalian_amplop`, `transaksi_ttb`.`keterangan` AS `keterangan`, `transaksi_ttb`.`photo` AS `photo`, `transaksi_ttb`.`satuan` AS `satuan`, `transaksi_ttb`.`nama_pengirim` AS `nama_pengirim`, `transaksi_ttb`.`alamat_pengirim` AS `alamat_pengirim`, `transaksi_ttb`.`hp_pengirim` AS `hp_pengirim`, `transaksi_ttb`.`nama_penerima` AS `nama_penerima`, `transaksi_ttb`.`alamat_penerima` AS `alamat_penerima`, `transaksi_ttb`.`hp_penerima` AS `hp_penerima`, `transaksi_ttb`.`status` AS `status`, `transaksi_ttb`.`tarif` AS `tarif`, `transaksi_ttb`.`provinsi` AS `provinsi`, `transaksi_ttb`.`kota` AS `kota`, `transaksi_ttb`.`kecamatan` AS `kecamatan` FROM `transaksi_ttb` WHERE `transaksi_ttb`.`status` = 1 ;
...
--
-- Indeks untuk tabel `lokasi_driver`
--
ALTER TABLE `lokasi_driver`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `transaksi_surat_jalan`
--
ALTER TABLE `transaksi_surat_jalan`
  ADD PRIMARY KEY (`id_surat_jalan`);

--
-- Indeks untuk tabel `transaksi_surat_jalan_detail`
--
ALTER TABLE `transaksi_surat_jalan_detail`
  ADD PRIMARY KEY (`id_detail`) USING BTREE;

--
-- Indeks untuk tabel `transaksi_ttb_history`
--
ALTER TABLE `transaksi_ttb_history`
...
--
-- AUTO_INCREMENT untuk tabel `lokasi_driver`
--
ALTER TABLE `lokasi_driver`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=168;

--
-- AUTO_INCREMENT untuk tabel `transaksi_surat_jalan_detail`
--
ALTER TABLE `transaksi_surat_jalan_detail`
  MODIFY `id_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `transaksi_ttb_history`
--
ALTER TABLE `transaksi_ttb_history`
